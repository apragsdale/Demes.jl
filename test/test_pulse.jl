@testset "Pulse" begin
    ...
    @test_throws Demes.PulseError Demes.validatePulseFields(
    ...
    @test_throws Demes.PulseError Demes.validatePulseDemes(
        Dict(
            "time" => 1,
            "dest" => "A",
            "sources" => ["A", "B"],
    ...
    # test bad pulse time
    @test_throws Demes.PulseError Demes.validatePulseTiming(
    ...
    @test_throws Demes.PulseError Demes.validatePulseProportions(
